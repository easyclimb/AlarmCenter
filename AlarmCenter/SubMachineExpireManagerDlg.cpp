...
BOOL CMachineExpireManagerDlg::OnInitDialog()
{
	...
	SetWindowText(TR(IDS_STRING_EXPIRE_DOC_NAME));
	SET_WINDOW_TEXT(IDC_STATIC_SELECTED, IDS_STRING_IDC_STATIC_SELECTED);
	SET_WINDOW_TEXT(IDC_BUTTON_ALL, IDS_STRING_IDC_BUTTON_ALL);
	SET_WINDOW_TEXT(IDC_BUTTON_ALL_NOT, IDS_STRING_IDC_BUTTON_ALL_NOT);
	SET_WINDOW_TEXT(IDC_BUTTON_INVERT, IDS_STRING_IDC_BUTTON_INVERT);
	SET_WINDOW_TEXT(IDC_BUTTON_EXPORT_SEL, IDS_STRING_IDC_BUTTON_EXPORT_SEL);
	SET_WINDOW_TEXT(IDC_BUTTON_PRINT_SEL, IDS_STRING_IDC_BUTTON_PRINT_SEL);
	SET_WINDOW_TEXT(IDC_BUTTON_TYPE_MANAGER, IDS_STRING_IDC_BUTTON_TYPE_MANAGER);
	SET_WINDOW_TEXT(IDC_BUTTON_SET_TYPE, IDS_STRING_IDC_BUTTON_SET_TYPE);
	SET_WINDOW_TEXT(IDC_BUTTON_EXTEND, IDS_STRING_IDC_EXTEND_THE_SELECTED_HOST_SERVICE);
	SET_WINDOW_TEXT(IDC_BUTTON_SET_REMIND_TIME, IDS_STRING_IDC_SET_THE_SELECTED_HOST_REMIND_TIME);
