...
BOOL CMannualyAddZoneWrite2MachineDlg::OnInitDialog()
{
	...
	SetWindowText(TR(IDS_STRING_IDC_Manually_Add_Protection_Zones_And_Written_To_The_Host));
	SET_WINDOW_TEXT(IDC_STATIC_1, IDS_STRING_IDC_STATIC_100);
	SET_WINDOW_TEXT(IDC_STATIC_2, IDS_STRING_IDC_STATIC_101);
	SET_WINDOW_TEXT(IDC_STATIC_3, IDS_STRING_IDC_STATIC_102);
	SET_WINDOW_TEXT(IDC_STATIC_4, IDS_STRING_IDC_STATIC_103);
	SET_WINDOW_TEXT(IDOK, IDS_STRING_IDC_BUTTON_MANULLY_ADD_ZONE_WRITE_TO_MACHINE);
