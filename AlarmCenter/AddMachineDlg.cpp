...
BOOL CAddMachineDlg::OnInitDialog()
{
	...
	SET_WINDOW_TEXT(IDC_STATIC_1, IDS_STRING_IDC_STATIC_008);
	SET_WINDOW_TEXT(IDC_STATIC_2, IDS_STRING_IDC_STATIC_010);
	SET_WINDOW_TEXT(IDC_STATIC_3, IDS_STRING_IDC_STATIC_017);
	SET_WINDOW_TEXT(IDC_STATIC_4, IDS_STRING_IDR_MENU4_POPUP_003_POPUP_004_ID_32794);
	SET_WINDOW_TEXT(IDC_STATIC_5, IDS_STRING_CONTACT);
	SET_WINDOW_TEXT(IDC_STATIC_6, IDS_STRING_IDC_STATIC_013);
	SET_WINDOW_TEXT(IDC_STATIC_7, IDS_STRING_IDC_STATIC_014);
	SET_WINDOW_TEXT(IDC_STATIC_8, IDS_STRING_IDC_STATIC_015);
	SET_WINDOW_TEXT(IDC_STATIC_9, IDS_STRING_IDC_STATIC_016);
	SET_WINDOW_TEXT(IDC_STATIC_NOTE_10, IDS_STRING_IDC_STATIC_NOTE);
	SET_WINDOW_TEXT(IDC_STATIC_NOTE3_11, IDS_STRING_IDC_STATIC_099);
	SET_WINDOW_TEXT(IDC_STATIC_12, IDS_STRING_RECEIVABLE);
	SET_WINDOW_TEXT(IDC_STATIC_13, IDS_STRING_IDC_STATIC_019);
	SET_WINDOW_TEXT(IDC_STATIC_14, IDS_STRING_IDC_STATIC_020);
	SET_WINDOW_TEXT(IDC_STATIC_15, IDS_STRING_DEVICE_ID);
	SET_WINDOW_TEXT(IDC_BUTTON_GROUP_3, IDS_STRING_IDC_BUTTON_GROUP);
	SET_WINDOW_TEXT(IDC_BUTTON_SET_EXPIRE, IDS_STRING_IDC_BUTTON_EXTEND);
	SET_WINDOW_TEXT(IDC_BUTTON_SET_ALARM, IDS_STRING_IDC_BUTTON_SET_ALARM);
