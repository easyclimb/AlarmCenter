...
void protobuf_AssignDesc_hellostreamingworld_2eproto() {
	protobuf_AddDesc_hellostreamingworld_2eproto();
	...
	static const int HelloRequest_offsets_[2] = {
	  ...
	  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(HelloRequest, num_greetings_),
	};
...
inline void protobuf_AssignDescriptorsOnce() {
	::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
									   &protobuf_AssignDesc_hellostreamingworld_2eproto);
}
...
void protobuf_AddDesc_hellostreamingworld_2eproto() {
	...
	::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
		...
		"rpc\242\002\003HSWb\006proto3", 257);
	...
	::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_hellostreamingworld_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_hellostreamingworld_2eproto {
	StaticDescriptorInitializer_hellostreamingworld_2eproto() {
		protobuf_AddDesc_hellostreamingworld_2eproto();
	}
} static_descriptor_initializer_hellostreamingworld_2eproto_;
...
const HelloRequest& HelloRequest::default_instance() {
	if (default_instance_ == NULL) protobuf_AddDesc_hellostreamingworld_2eproto();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
	...
	for (;;) {
		...
		case 1:
		{
			...
			if (input->ExpectTag(18)) goto parse_num_greetings;
			break;
		}
		...
		case 2:
		{
			...
			parse_num_greetings:
				...
				DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
					this->num_greetings().data(), this->num_greetings().length(),
					::google::protobuf::internal::WireFormatLite::PARSE,
...
void HelloRequest::InternalSwap(HelloRequest* other) {
	...
	num_greetings_.Swap(&other->num_greetings_);
...
// optional string num_greetings = 2;
void HelloRequest::clear_num_greetings() {
	num_greetings_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
const ::std::string& HelloRequest::num_greetings() const {
...
void HelloRequest::set_num_greetings(const ::std::string& value) {
...
void HelloRequest::set_num_greetings(const char* value) {
...
void HelloRequest::set_num_greetings(const char* value, size_t size) {
...
::std::string* HelloRequest::mutable_num_greetings() {
...
::std::string* HelloRequest::release_num_greetings() {
...
void HelloRequest::set_allocated_num_greetings(::std::string* num_greetings) {
