...
HRESULT __stdcall CWebBrowserBase::GetTypeInfoCount(
	unsigned int * pctinfo)
{
	return E_NOTIMPL;
}

HRESULT __stdcall CWebBrowserBase::GetTypeInfo(
	unsigned int iTInfo,
	LCID lcid,
...
HRESULT __stdcall CWebBrowserBase::GetIDsOfNames(
	REFIID riid,
...
HRESULT __stdcall CWebBrowserBase::Invoke(
	DISPID dispIdMember,
	REFIID riid,
	LCID lcid,
	WORD wFlags,
...
HRESULT __stdcall CWebBrowserBase::RemoveMenus(HMENU h)
{
	return E_NOTIMPL;
}
HRESULT __stdcall CWebBrowserBase::InsertMenus(HMENU h, LPOLEMENUGROUPWIDTHS x)
{
	return E_NOTIMPL;
}

HRESULT __stdcall CWebBrowserBase::SetMenu(HMENU h, HOLEMENU hO, HWND hw)
{
	return E_NOTIMPL;
}
...
IWebBrowser2* CWebBrowserBase::GetWebBrowser2()
{
	...
	HRTEST_SE(_pOleObj->QueryInterface(IID_IWebBrowser2, 
		(void**)&_pWB2), L"QueryInterface IID_IWebBrowser2 失败");
	return _pWB2;
RETURN:
	return NULL;
}
...
{
	BOOL bRet = FALSE;
	HRTEST_E(GetWebBrowser2()->Navigate(pVarUrl->bstrVal, 0, 0, 0, 0), L"GetWebBrowser2 失败");
	bRet = TRUE;
RETURN:
	return bRet;
}
