...
CTestTreeDlg::CTestTreeDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CTestTreeDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CTestTreeDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
void CTestTreeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CTestTreeDlg::OnQueryDragIcon()
{
