...
BOOL CVideoPlayerDlg::OnInitDialog()
{
	...
	SET_WINDOW_TEXT(IDC_STATIC_NOTE_3, IDS_STRING_Longest_Time_Background_Video_Footage);	//后台视频录像最长时间
	SET_WINDOW_TEXT(IDC_STATIC_MINUTE_4, IDS_STRING_IDC_STATIC_MINUTE);
