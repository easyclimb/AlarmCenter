...
BOOL CVideoUserManagerDlg::OnInitDialog()
{
	...
	SetWindowText(TR(IDS_STRING_IDC_BUTTON_MGR_VIDEO_USER));
	SET_WINDOW_TEXT(IDC_STATIC_1, IDS_STRING_IDC_STATIC_105);
	SET_WINDOW_TEXT(IDC_STATIC_2, IDS_STRING_IDC_STATIC_106);
	SET_WINDOW_TEXT(IDC_STATIC_3, IDS_STRING_IDC_STATIC_104);
	SET_WINDOW_TEXT(IDC_STATIC_4, IDS_STRING_NAME);
	SET_WINDOW_TEXT(IDC_STATIC_TOKEN_OR_NAME, IDS_STRING_ACCESS_TOKEN);
	SET_WINDOW_TEXT(IDC_STATIC_5, IDS_STRING_IDC_STATIC_027);
	SET_WINDOW_TEXT(IDC_STATIC_TIME_OR_PASSWD, IDS_STRING_IDC_STATIC_TIME_OR_PASSWD);
	SET_WINDOW_TEXT(IDC_STATIC_6, IDS_STRING_IDC_STATIC_109);
	SET_WINDOW_TEXT(IDC_STATIC_7, IDS_STRING_ID);
	SET_WINDOW_TEXT(IDC_STATIC_DEV_NAME, IDS_STRING_IDC_STATIC_011);
	SET_WINDOW_TEXT(IDC_STATIC_8, IDS_STRING_IDC_STATIC_025);
	SET_WINDOW_TEXT(IDC_STATIC_VERIFY_CODE, IDS_STRING_IDC_STATIC_VERIFY_CODE);
	//SET_WINDOW_TEXT(IDC_STATIC_NOTE, IDS_STRING_IDC_STATIC_104);	//提示:请填写摄像机背后标签上所显示的6位大写字母
	SET_WINDOW_TEXT(IDC_STATIC_11, IDS_STRING_IDC_STATIC_112);

	SET_WINDOW_TEXT(IDC_BUTTON_REFRESH_DEV, IDS_STRING_IDC_BUTTON_REFRESH_DEV);
	SET_WINDOW_TEXT(IDC_BUTTON_UNBIND, IDS_STRING_IDC_BUTTON_UNBIND);
	SET_WINDOW_TEXT(IDC_BUTTON_BIND_OR_UNBIND, IDS_STRING_BIND_ZONE);
	SET_WINDOW_TEXT(IDC_BUTTON_PLAY, IDS_STRING_IDC_BUTTON_PLAY);
	SET_WINDOW_TEXT(IDC_BUTTON_SAVE_DEV, IDS_STRING_IDC_BUTTON_SAVE_CHANGE);
	SET_WINDOW_TEXT(IDC_BUTTON_DEL_DEVICE, IDS_STRING_IDC_BUTTON_DEL_DEVICE);
	SET_WINDOW_TEXT(IDC_BUTTON_ADD_DEVICE, IDS_STRING_IDC_BUTTON_ADD_DEVICE);
	SET_WINDOW_TEXT(IDC_BUTTON_REFRESH_DEVICE_LIST, IDS_STRING_IDC_BUTTON_REFRESH_DEVICE_LIST);
	SET_WINDOW_TEXT(IDC_BUTTON_SAVE_CHANGE, IDS_STRING_IDC_BUTTON_SAVE_CHANGE);
	SET_WINDOW_TEXT(IDC_BUTTON_DEL_USER, IDS_STRING_IDC_BUTTON_DEL_USER);
	SET_WINDOW_TEXT(IDC_BUTTON_ADD_USER, IDS_STRING_IDC_BUTTON_ADD_USER);

	SET_WINDOW_TEXT(IDC_CHECK_BY_SSE_ID, IDS_STRING_CONN_BY_SSE);
	SET_WINDOW_TEXT(IDC_STATIC_SSE_ID, IDS_STRING_IDC_STATIC_SSE_ID);
	SET_WINDOW_TEXT(IDC_STATIC_IP, IDS_STRING_IDC_STATIC_IP);
	SET_WINDOW_TEXT(IDC_STATIC_PORT, IDS_STRING_IDC_STATIC_PORT);
	SET_WINDOW_TEXT(IDC_STATIC_USER_NAME, IDS_STRING_IDC_STATIC_003);
	SET_WINDOW_TEXT(IDC_STATIC_USER_PASSWD, IDS_STRING_IDC_STATIC_022);
	
	SET_WINDOW_TEXT(IDC_STATIC_NOTE, IDS_STRING_IDC_Note_Please_Fill_Out_The_Camera);
...
void CVideoUserManagerDlg::InitUserList()
{
	...
	video::user_list userList;
	vmgr->GetVideoUserList(userList);

	for (auto userInfo : userList) {
		const auto& produtor = userInfo->get_productor();
		if (produtor.get_productor_type() == video::EZVIZ) {
			auto ezvizUserInfo = std::dynamic_pointer_cast<video::ezviz::ezviz_user>(userInfo);
			InsertUserListEzviz(ezvizUserInfo);
		} else if (produtor.get_productor_type() == video::JOVISION) {
			auto normalUserInfo = std::dynamic_pointer_cast<video::jovision::jovision_user>(userInfo);
...
void CVideoUserManagerDlg::InsertUserListEzviz(video::ezviz::ezviz_user_ptr userInfo)
{
	int nResult = -1;
	LV_ITEM lvitem = { 0 };
	CString tmp = _T("");
...
void CVideoUserManagerDlg::UpdateUserListEzviz(int nItem, video::ezviz::ezviz_user_ptr userInfo)
{
	LV_ITEM lvitem = { 0 };
	CString tmp = _T("");
...
void CVideoUserManagerDlg::InsertUserListJovision(video::jovision::jovision_user_ptr userInfo)
{
	int nResult = -1;
	LV_ITEM lvitem = { 0 };
	CString tmp = _T("");
...
void CVideoUserManagerDlg::UpdateUserListJovision(int nItem, video::jovision::jovision_user_ptr userInfo)
{
	LV_ITEM lvitem = { 0 };
	CString tmp = _T("");
...
void CVideoUserManagerDlg::UpdateDeviceListEzviz(int nItem, video::ezviz::ezviz_device_ptr deviceInfo)
{
	AUTO_LOG_FUNCTION;
	LV_ITEM lvitem = { 0 };
	CString tmp = _T("");
...
void CVideoUserManagerDlg::InsertDeviceListEzviz(video::ezviz::ezviz_device_ptr deviceInfo)
{
	AUTO_LOG_FUNCTION;
	int nResult = -1;
	LV_ITEM lvitem = { 0 };
...
void CVideoUserManagerDlg::InsertDeviceListJovision(video::jovision::jovision_device_ptr deviceInfo)
{
	AUTO_LOG_FUNCTION;
	int nResult = -1;
	LV_ITEM lvitem = { 0 };
...
void CVideoUserManagerDlg::UpdateDeviceListJovision(int nItem, video::jovision::jovision_device_ptr deviceInfo)
{
	AUTO_LOG_FUNCTION;
	LV_ITEM lvitem = { 0 };
	CString tmp = _T("");
...
void CVideoUserManagerDlg::OnLvnItemchangedListDeviceEzviz(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	video::ezviz::ezviz_device_ptr dev = video::video_manager::get_instance()->GetVideoDeviceInfoEzviz(pNMLV->lParam);
...
void CVideoUserManagerDlg::ShowDeviceInfoEzviz(video::ezviz::ezviz_device_ptr device)
{
	AUTO_LOG_FUNCTION;
	if (!device) {
		ResetDeviceListSelectionInfoEzviz();
...
void CVideoUserManagerDlg::ShowDeviceInfoJovision(video::jovision::jovision_device_ptr device)
{
	AUTO_LOG_FUNCTION;
...
void CVideoUserManagerDlg::ShowUsersDeviceListEzviz(video::ezviz::ezviz_user_ptr user)
{
	AUTO_LOG_FUNCTION;
	...
	txt.Format(L"%s", user->get_productor().get_formatted_name().c_str());
	...
	ResetDeviceListSelectionInfoEzviz();
	for (auto i : list) {
		video::ezviz::ezviz_device_ptr device = std::dynamic_pointer_cast<video::ezviz::ezviz_device>(i);
...
void CVideoUserManagerDlg::ShowUsersDeviceListJovision(video::jovision::jovision_user_ptr user)
{
	AUTO_LOG_FUNCTION;
	...
	ResetDeviceListSelectionInfoJovision();
	for (auto i : list) {
		video::jovision::jovision_device_ptr device = std::dynamic_pointer_cast<video::jovision::jovision_device>(i);
...
void CVideoUserManagerDlg::OnBnClickedButtonAddUser()
{
	...
	if (ret == 1) {
		...
		auto user = std::make_shared<video::jovision::jovision_user>();
...
void CVideoUserManagerDlg::OnBnClickedButtonSaveDev()
{
	...
	if (ndx == 0) {
		...
		do {
			...
			if (!code.IsEmpty()) {
				if (!video::ezviz::ezviz_device::IsValidVerifyCode(utf8::w2a((LPCTSTR)code))) {
...
void CVideoUserManagerDlg::OnBnClickedButtonUnbind()
{
	...
	if (ndx == 0) {
		if (m_curSelDeviceInfoEzviz == nullptr || m_curselDeviceListItemEzviz == -1) { return; }
		auto dev = std::dynamic_pointer_cast<video::ezviz::ezviz_device>(m_curSelDeviceInfoEzviz);
		auto mgr = video::video_manager::get_instance();
		std::list<video::zone_uuid> zoneList;
...
void CVideoUserManagerDlg::OnBnClickedButtonDelDevice()
{
	...
	if (ndx == 0) {
		if (m_curSelDeviceInfoEzviz == nullptr || m_curselDeviceListItemEzviz == -1) { return; }
		auto dev = std::dynamic_pointer_cast<video::ezviz::ezviz_device>(m_curSelDeviceInfoEzviz);
		auto user = std::dynamic_pointer_cast<video::ezviz::ezviz_user>(dev->get_userInfo());
		mgr->execute_del_ezviz_users_device(user, dev);
		m_curSelDeviceInfoEzviz = nullptr;
		...
		if (m_curSelDeviceInfoJovision == nullptr || m_curselDeviceListItemJovision == -1) { return; }
		auto dev = std::dynamic_pointer_cast<video::jovision::jovision_device>(m_curSelDeviceInfoJovision);
		auto user = std::dynamic_pointer_cast<video::jovision::jovision_user>(dev->get_userInfo());
...
void CVideoUserManagerDlg::OnNMDblclkListDeviceEzviz(NMHDR *pNMHDR, LRESULT *pResult)
{
	*pResult = 0;
	...
	video::ezviz::ezviz_device_ptr dev = video::video_manager::get_instance()->GetVideoDeviceInfoEzviz(data);
	if (!dev) {
		return;
	}
...
void CVideoUserManagerDlg::OnNMDblclkListDeviceJovision(NMHDR *pNMHDR, LRESULT *pResult)
{
	*pResult = 0;
	...
	video::jovision::jovision_device_ptr dev = video::video_manager::get_instance()->GetVideoDeviceInfoJovision(data);
	if (!dev) {
		return;
	}
