...
public:
	...
	typedef WithAsyncMethod_update_db<WithAsyncMethod_get_is_show_video_user_mgr_dlg<WithAsyncMethod_get_alarming_devs<WithAsyncMethod_get_updated_bind_infos<WithAsyncMethod_insert_history_record<WithAsyncMethod_delete_camera_info<Service > > > > > > AsyncService;
	template <class BaseClass>
